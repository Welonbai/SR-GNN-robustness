...
INTERNAL_RANDOM_INSERTION_SUCCESSOR_REPAIR_NONZERO_WHEN_POSSIBLE_RUN_TYPE = (
    "internal_random_insertion_successor_repair_nonzero_when_possible"
)
...
INTERNAL_RANDOM_INSERTION_SUCCESSOR_SEEDED_GENERATED_CONTINUATION_NONZERO_WHEN_POSSIBLE_RUN_TYPE = (
    "internal_random_insertion_successor_seeded_generated_continuation_nonzero_when_possible"
)
