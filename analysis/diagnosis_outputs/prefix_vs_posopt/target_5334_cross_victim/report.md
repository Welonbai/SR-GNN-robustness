# Prefix vs PosOptMVP Diagnosis: target5334_cross_victim

## What Was Analyzed

Cross-victim slice for target 5334 on TRON, MIARec, and SR-GNN, using the shared Prefix and PosOptMVP target-level artifacts.
...
| --- | --- | --- | --- | --- | --- |
| 5334 | miasrec | targeted_mrr@10 | 0.021468 | 0.018042 | -0.003426 |
| 5334 | miasrec | targeted_recall@10 | 0.092921 | 0.083013 | -0.009908 |
| 5334 | srgnn | targeted_mrr@10 | 0.016330 | 0.034332 | 0.018001 |
| 5334 | srgnn | targeted_recall@10 | 0.044316 | 0.091278 | 0.046962 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5334 | True |  | 6499 | 0.289891 | 0.297123 | 0.291737 | 0.294199 | 0.669641 | 0.040468 | 1.696569 | 1 |
...
- For target 5334 on miasrec, Prefix wins while using a much stronger position-0 bias (0.711 vs 0.294). That supports an early-position-bias explanation more than a broad target-quality explanation.
- For target 5334 on miasrec, Prefix and PosOpt match on the exact selected position only 0.290 of the time, so different target-context compatibility is a plausible contributor.
...
- For target 5334 on srgnn, PosOpt improves targeted Recall@10 over Prefix by 0.047. This serves as a useful control case showing that broader position search can help when the target benefits from a less front-loaded replacement pattern.
...
- For target 5334, the PosOpt policy stays relatively diffuse (entropy drop 0.047, final max-position share 0.291), which is consistent with a policy training instability or weak concentration explanation.
- For shared target 5334, Prefix and PosOpt use the same target-level poisoned-session pool across victims, yet the PosOpt-minus-Prefix Recall@10 delta ranges from -0.142 (tron) to 0.047 (srgnn). That points to victim-model sensitivity rather than per-victim differences in final positions.

## Output Files

- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/metrics_comparison.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/position_comparison.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/per_session_join.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/per_session_context_join.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/context_comparison.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/top_replaced_original_items.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/top_left_neighbors.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/top_right_neighbors.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/posopt_training_dynamics.csv`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/targeted_metrics_overview.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/final_position_histogram_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/normalized_position_histogram_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/posopt_reward_curve_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/posopt_baseline_curve_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/posopt_advantage_curve_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/posopt_mean_entropy_curve_target_5334.png`
- `analysis/diagnosis_outputs/prefix_vs_posopt/target_5334_cross_victim/plots/posopt_average_selected_position_curve_target_5334.png`
