...
- config: `attack/configs/diginetica_attack_rank_bucket_cem_mean_ft100_srgnn_target5334.yaml`
- CEM run: `outputs/runs/diginetica/attack_rank_bucket_cem_mean_ft100_srgnn_target5334/run_group_11d9031bfd`
...
|---:|---:|---:|---:|---:|
| 5334 | 0.0001398061 | 0.0003682743 | 0.0002284682 | 0.0000000001 |

## Readout

- CEM rescored surrogate reward beats Random-NZ on 1/1 target(s).
- On final targeted recall/mrr@10/20/30 across victims, CEM beats Random-NZ on 2/6 cell(s).
